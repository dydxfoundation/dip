...
## Simple Summary
The purpose of this DIP is to reduce the the liquidity provider rewards threshold for market makers from 5% to 1% so that smaller and medium-sized market makers can be included as well.
